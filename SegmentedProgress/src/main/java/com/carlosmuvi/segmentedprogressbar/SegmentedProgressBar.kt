...
class SegmentedProgressBar : View {
    ...
    lateinit var listener: SegmentedProgressListener
    ...
    private fun initDrawingTimer() {
        ...
        drawingTimer.setListener(object : DrawingTimer.Listener {
            override fun onTick(currentTicks: Int, totalTicks: Int) {
...
/*
   ...
   */
    ...
    fun isRunning() = drawingTimer.isRunning
    fun isIdle() = drawingTimer.isIdle
    ...
    public interface SegmentedProgressListener {
        fun onFinish()
    }
}
