...
public class EasyVideoPlayer extends FrameLayout
    ...
    public void setBottomLabelText(@Nullable CharSequence text) {
        ...
        else mLabelBottom.setVisibility(View.GONE);
    }
    ...
    private void invalidateThemeColors() {
        final int labelColor = Color.WHITE;
        mControlsFrame.setBackgroundColor(getResources().getColor(android.R.color.transparent));
