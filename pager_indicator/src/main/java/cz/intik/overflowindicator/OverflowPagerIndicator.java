...
public class OverflowPagerIndicator extends LinearLayout {
    ...
    private static final int INDICATOR_SIZE_DIP = 7;
    ...
    private static final float STATE_SMALLEST = 0.5f;
    private static final float STATE_SMALL = 0.5f;
    private static final float STATE_NORMAL = 0.5f;
    private static final float STATE_SELECTED = 0.7f;
    ...
    private void updateOverflowState(int position) {
        ...
        int start = position - MAX_INDICATORS + 2;
