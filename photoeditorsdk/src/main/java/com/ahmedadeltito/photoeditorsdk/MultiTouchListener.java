...
class MultiTouchListener implements OnTouchListener {
    ...
    private boolean isScaleReset = true;
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (isViewInBounds(deleteView, x, y)) {
                    if (!isScaled) {
                        ...
                        ViewAnimator.animate(view).scale(0.6f).duration(100).start();
                    }
//                    view.animate().scaleX(0.25f).scaleY(0.25f);
                } else {
                    if (!isScaleReset) {

                        ViewAnimator.animate(view).scale(defaultScale).duration(100).start();
                        isScaleReset = true;
                        isScaled = false;
            ...
            case MotionEvent.ACTION_UP:
                ...
                if (Math.abs(mCurrentCancelX - mPrevRawX) < 5 || Math.abs(mCurrentCancelY - mPrevRawY) < 5) {
                    if (view instanceof TextView) {
                        ...
                        if (onPhotoEditorSDKListener != null) {
                            onPhotoEditorSDKListener.onEditTextChangeListener(
                                    ((TextView) view).getText().toString(), ((TextView) view).getCurrentTextColor(), ((TextView) view).getBackground(), ((TextView) view).getTextSize());
                        }
                    }
                }
                break;
    ...
    interface OnMultiTouchListener {
        //        void onEditTextClickListener(String text, int colorCode, Drawable backgroundDrawable, float textSize);
        void onEditTextClickListener(View view);
