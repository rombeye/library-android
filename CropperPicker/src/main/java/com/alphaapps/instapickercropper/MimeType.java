...
/**
 * MIME Type enumeration to restrict selectable media on the selection activity. InstaCropperPicker only supports images and
 * videos.
 * <p>
...
public enum MimeType {
    ...
    public static MimeType getTypeFromString(String type){
        for (MimeType mimeType : MimeType.values()) {
            Log.v("aws", mimeType.toString());
            if(mimeType.toString().equals(type))
                return mimeType;
        }
        return null;
    }
