...
/**
 * Entry for InstaCropperPicker's media selection.
 */
public final class InstaCropperPicker {

    private final WeakReference<Activity> mContext;
    private final WeakReference<Fragment> mFragment;

    private InstaCropperPicker(Activity activity) {
        this(activity, null);
    }

    private InstaCropperPicker(Fragment fragment) {
        this(fragment.getActivity(), fragment);
    }

    private InstaCropperPicker(Activity activity, Fragment fragment) {
        mContext = new WeakReference<>(activity);
        mFragment = new WeakReference<>(fragment);
    }

    /**
     * Start InstaCropperPicker from an Activity.
     * <p>
     * This Activity's {@link Activity#onActivityResult(int, int, Intent)} will be called when user
     * finishes selecting.
     *
     * @param activity Activity instance.
     * @return InstaCropperPicker instance.
     */
    public static InstaCropperPicker from(Activity activity) {
        return new InstaCropperPicker(activity);
    }

    /**
     * Start InstaCropperPicker from a Fragment.
     * <p>
     ...
     * @return InstaCropperPicker instance.
     */
    public static InstaCropperPicker from(Fragment fragment) {
        return new InstaCropperPicker(fragment);
    }
    ...
    public static List<Uri> obtainResult(Intent data) {
        return data.getParcelableArrayListExtra(CropperPickerActivity.EXTRA_RESULT_SELECTION);
    }
    ...
    public static List<String> obtainPathResult(Intent data) {
        return data.getStringArrayListExtra(CropperPickerActivity.EXTRA_RESULT_SELECTION_PATH);
    }
