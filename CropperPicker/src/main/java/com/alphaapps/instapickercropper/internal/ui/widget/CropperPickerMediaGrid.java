...
public class CropperPickerMediaGrid extends SquareFrameLayout implements View.OnClickListener {

    private ImageView mThumbnail;
    private TextView mediaCheckedMaskIV;
    ...
    public CropperPickerMediaGrid(Context context) {
        super(context);
        init(context);
    }

    public CropperPickerMediaGrid(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    private void init(Context context) {
        LayoutInflater.from(context).inflate(R.layout.cropper_picker_media_grid_content, this, true);
    ...
    public void onClick(View v) {
        if (mListener != null) {
            if (v == mCheckView || v == mThumbnail || v == this) {
