 ...
 */
package com.alphaapps.instapickercropper.internal.ui.widget;
...
//                STROKE_RADIUS * mDensity, mStrokePaint);
        ...
        if (mCountable) {
            if (mCheckedNum != UNCHECKED) {
                ...
                //draw blue circle as a check mark //default by the library
//                canvas.drawCircle((float) SIZE * mDensity / 2, (float) SIZE * mDensity / 2,
//                        BG_RADIUS * mDensity, mBackgroundPaint);
                ...
                //Rombeye design // add shadow behind the number
                Rect background = new Rect(0,0,canvas.getWidth(),canvas.getHeight());
                canvas.drawRect(background, mBackgroundPaint);

                //Rombeye design // add the number of the image to the center of the selected img
    ...
    private void initBackgroundPaint() {
        if (mBackgroundPaint == null) {
            ...
            int defaultColor = ResourcesCompat.getColor(
                    getResources(), R.color.zhihu_item_checked_images_backgroundColor,
                    getContext().getTheme());
            int color = ta.getColor(0, defaultColor);
            ta.recycle();
    ...
    private void initTextPaint() {
        if (mTextPaint == null) {
            ...
            Typeface IKANSEEYOUALL = Typeface.createFromAsset(getContext().getAssets(), "fonts/IKANSEEYOUALL.otf");
            mTextPaint.setTypeface(IKANSEEYOUALL);
//            mTextPaint.setTypeface(Typeface.create(Typeface.DEFAULT_BOLD, Typeface.BOLD));
            mTextPaint.setTextSize(56 * mDensity);
        }
    }
