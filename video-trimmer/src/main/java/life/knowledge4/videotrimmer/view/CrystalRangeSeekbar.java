...
import life.knowledge4.videotrimmer.interfaces.OnRangeSeekbarChangeListener;
import life.knowledge4.videotrimmer.interfaces.OnRangeSeekbarFinalValueListener;
...
public class CrystalRangeSeekbar extends View {
    ...
    private final Paint mBar = new Paint();
    ...
    private int leftDrawablePressed;
    private int rightDrawablePressed;
...
//            rightDrawable = getRightDrawable(array);
            leftDrawable = R.drawable.ic_left_slider;
            rightDrawable = R.drawable.ic_right_slider;
            ///////////
            leftDrawablePressed = R.drawable.ic_left_slider;
            rightDrawablePressed = R.drawable.ic_right_slider;
...
//            rightDrawablePressed = getRightDrawablePressed(array);
    ...
    protected void init() {
        ...
        mBar.setAntiAlias(true);
        mBar.setColor(ContextCompat.getColor(getContext(), R.color.background_video_color));
    ...
    public void apply() {
        ...
        xLeft = normalizedToScreen(normalizedMinValue) + getPaddingLeft();
        xRight = normalizedToScreen(normalizedMaxValue) + getPaddingLeft();
...
//        return thumbWidth * 0.5f;
    ...
    ////////////////
    protected Bitmap getBitmap(int drawable) {
        return getBitmapFromVectorDrawable(getContext(), drawable);
    }

    protected Bitmap getBitmap(Drawable drawable) {
        return getBitmapFromVectorDrawable(getContext(), R.drawable.ic_thumb);
    }
...
//        rectLeftThumb.top = mHeightTimeLine / 2 - getThumbWidth() / 2;
        rectLeftThumb.top = 0f;
        rectLeftThumb.bottom = thumbHeight;

        xLeft = normalizedToScreen(normalizedMinValue) + getPaddingLeft();
        Rect mRect = new Rect((int) getThumbWidth() / 2, 0, (int) (xLeft + getThumbWidth() / 2), (int) (mHeightTimeLine + getThumbWidth() / 2) + 5);
        canvas.drawRect(mRect, mShadow);

        Rect mRect2 = new Rect((int) (xLeft + getThumbWidth() / 2) - 4, 0, (int) (xLeft + getThumbWidth() / 2) + 4, (int) (mHeightTimeLine + getThumbWidth() / 2) + 5);
        canvas.drawRect(mRect2, mBar);
...
//        rectRightThumb.top = mHeightTimeLine / 2 - getThumbWidth() / 2;
        rectRightThumb.top =0f;
        rectRightThumb.bottom = thumbHeight;
        xRight = rectRightThumb.left - getPaddingRight();
        Rect mRect = new Rect((int) (xRight + getThumbWidth() / 2), 0, (int) (mViewWidth - getThumbWidth() / 2), (int) (mHeightTimeLine + getThumbWidth() / 2) + 5);
//        Rect mRect = new Rect((int) (xRight + getThumbWidth() / 2), (int) (getThumbWidth() / 2) + 2, (int) (mViewWidth - getThumbWidth() / 2), (int) (mHeightTimeLine + getThumbWidth() / 2) + 3);

        canvas.drawRect(mRect, mShadow);

        Rect mRect2 = new Rect((int) (xRight + getThumbWidth() / 2) - 4, 0, (int) (xRight + getThumbWidth() / 2) + 4, (int) (mHeightTimeLine + getThumbWidth() / 2) + 5);
        canvas.drawRect(mRect2, mBar);
...
//        setupHighlightBar(canvas, _paint, _rect);
    ...
    protected synchronized void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int minH = getPaddingBottom() + getPaddingTop() + (int) getThumbHeight() + mHeightTimeLine + (int) getThumbHeight() + (int) getThumbHeight();
        int viewHeight = resolveSizeAndState(minH, heightMeasureSpec, 1);

        setMeasuredDimension(getMeasureSpecWith(widthMeasureSpec), viewHeight);
    }
    ...
    public synchronized boolean onTouchEvent(MotionEvent event) {
        ...
        switch (action & MotionEvent.ACTION_MASK) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                break;
            case MotionEvent.ACTION_POINTER_DOWN: { Rect mRect = new Rect((int) (xRight + getThumbWidth() / 2), 0, (int) (mViewWidth - getThumbWidth() / 2), (int) (mHeightTimeLine + getThumbWidth() / 2) + 5);
