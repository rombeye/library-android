...
public class CheckView extends View {
    ...
    private static final int SIZE = 30; // dp
    ...
    private Drawable mCheckDrawable, mDefaultDrawable;
    ...
    private void init(Context context) {
        ...
        mCheckDrawable = ResourcesCompat.getDrawable(context.getResources(),
                R.drawable.selected_gallery_icon, context.getTheme());
        mDefaultDrawable = ResourcesCompat.getDrawable(context.getResources(),
                R.drawable.default_gallery_icon, context.getTheme());
    }
...
//                STROKE_RADIUS * mDensity, mStrokePaint);
        ...
        mDefaultDrawable.setBounds(getCheckRect());
...
//                        BG_RADIUS * mDensity, mBackgroundPaint);
    ...
    private void initBackgroundPaint() {
        if (mBackgroundPaint == null) {
            ...
            int defaultColor = ResourcesCompat.getColor(
                    getResources(), R.color.turquoise,
                    getContext().getTheme());
            int color = ta.getColor(0, defaultColor);
            ta.recycle();
    ...
    private Rect getCheckRect() {
        if (mCheckRect == null) {
            ...
            Log.v("Padding", ""+rectPadding);
            mCheckRect = new Rect(rectPadding, rectPadding,
                    (int) (SIZE * mDensity - rectPadding), (int) ((SIZE * mDensity - rectPadding)));
            //mCheckRect = new Rect(0, 0, 24, 18);
            Log.v("hello", "right: "+(int) (SIZE * mDensity - rectPadding)+" bottom: "+(int) ((SIZE * mDensity - rectPadding)/1.3));
        }
