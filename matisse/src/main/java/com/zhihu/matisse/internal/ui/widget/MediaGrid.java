...
//
//            } else
                if (v == mCheckView || v == mThumbnail) {
//                    if(mThumbnail.getImageAlpha() == 170){
//                        mThumbnail.setImageAlpha(255);
//                    }else{
//                        mThumbnail.setImageAlpha(170);
//                    }
                mListener.onCheckViewClicked(mCheckView, mMedia, mPreBindInfo.mViewHolder);
            }
        }
    }
    public ImageView getThumbnail(){return mThumbnail;}
