...
import com.zhihu.matisse.CustomTextView;
...
public abstract class BasePreviewActivity extends AppCompatActivity implements View.OnClickListener,
    ...
    protected CustomTextView mButtonBack;
    protected CustomTextView mButtonApply;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mButtonBack = (CustomTextView) findViewById(R.id.button_back);
        mButtonApply = (CustomTextView) findViewById(R.id.button_apply);
