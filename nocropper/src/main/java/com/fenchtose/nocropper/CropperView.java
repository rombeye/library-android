...
public class CropperView extends FrameLayout {
    ...
    public Bitmap getImageBitmap() {
        return mImageView.getImageBitmap();
    }
    ...
    public float getBaseZoom() {
        return mImageView.getmBaseZoom();
    }
    ...
    public int getCropperHeight() {
        return mImageView != null ? mImageView.getHeight() : 0;
    }
    ...
    public boolean isCropping() {
        return mImageView.isCropping();
    }


    public boolean isAdjusting() {
        return mImageView.isAdjusting();
    }
}
